...
print('Linear Regression test_error for lambda=1 =', run_linear_regression_on_MNIST(lambda_factor=1))
# print('Linear Regression test_error for lambda=0.1  =', run_linear_regression_on_MNIST(lambda_factor=0.1))
# print('Linear Regression test_error for lambda=0.01  =', run_linear_regression_on_MNIST(lambda_factor=0.01))
...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    # Print the test error with mod 3 labels
    print("Test Error (Mod 3 Labels):", test_error_mod3)

    # Return original test error
    return test_error

#print('softmax (0.5) test_error=', run_softmax_on_MNIST(temp_parameter=0.5))
print('softmax (1) test_error=', run_softmax_on_MNIST(temp_parameter=1))
#print('softmax (2) test_error=', run_softmax_on_MNIST(temp_parameter=2))
...
print('softmax_mod3 (1) test_error=', run_softmax_on_MNIST_mod3(temp_parameter=1))
...
print('Test error with 18 PCs:', test_error)
...
print('Test error with cubic kernel:', test_error)
...
test_error = compute_test_error_svm(test_y, pred_test_y)
print('Test error with SVC Ply kernel:', test_error)
...
pred_test_y = clf.predict(test_pca10)
test_error = compute_test_error_svm(test_y, pred_test_y)
print('Test error with rbf:', test_error)
